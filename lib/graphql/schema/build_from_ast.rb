module GraphQL
  class Schema
    module BuildFromAST
      ...
      def build_schema_from_ast(document)
        raise 'Must provide a document ast.' if !document || !document.is_a?(GraphQL::Language::Nodes::Document)
        ...
        document.definitions.each do |definition|
          ...
          when GraphQL::Language::Nodes::SchemaDefinition
            raise 'Must provide only one schema definition.' if schema_definition
        ...
        if schema_definition
          if schema_definition.query
            raise "Specified query type \"#{schema_definition.query}\" not found in document." unless types[schema_definition.query]
            query_root_type = types[schema_definition.query]
          end

          if schema_definition.mutation
            raise "Specified mutation type \"#{schema_definition.mutation}\" not found in document." unless types[schema_definition.mutation]
            mutation_root_type = types[schema_definition.mutation]
          end

          if schema_definition.subscription
            raise "Specified subscription type \"#{schema_definition.subscription}\" not found in document." unless types[schema_definition.subscription]
        ...
        raise 'Must provide schema definition with query type or a type named Query.' unless query_root_type
      ...
      def resolve_type(types, ast_node)
        ...
        when GraphQL::Language::Nodes::TypeName
          ...
          when "ID"
            ...
            raise "Type \"#{type_name}\" not found in document." unless types[type_name]
            types[type_name]
          end
